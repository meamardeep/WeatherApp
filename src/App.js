...
function App() {
  ...
  // useEffect( async () => {
  //        const response = await fetch("http://api.weatherapi.com/v1/current.json?key=9226baddfee64796960172156231407&q=London&aqi=no");
  //        if(response.ok){
    ...
    <div className="App">
      ...
      {weatherData && (
        <div className='card d-flex justify-content-center'>
          <img style={{width: "8rem" , display:'flex', justifyContent : 'center'}} className='card-img-top Weather-logo' src='/weather_logo.jpg'/>
          ...
          <h6 style={{marginBottom:'20px'}}><img style={{width : '4rem'}} src='/Humidity.png'/><h5>{weatherData.current.humidity} Humidity</h5></h6>
